...
with st.sidebar:
    ...
    ## st.image('D:\Python\dashboard e-commerce\dashboard\shopee.png')
...
##Dashboard
st.header('Brazil E-Commerce Report Dashboard :sparkles:')
...
st.caption('Copyright (c) Risma Fahrella Fiorentina 2023')